...
const routes: Routes = [
  {
    ...
    children: [
      { path: 'analytics-board', loadChildren: () => import('./dashboard/dashboard.module').then(m=>m.DashboardModule), data: {extraParameter: 'dashboardsMenu'} },
      // Dashboads
  ...
  {
    path: 'analytics-board',
    component: DashboardComponent
  },
  {path: '**', redirectTo: '/analytics-board'}
];
